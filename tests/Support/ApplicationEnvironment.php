...
namespace RRZE\Newsletter {
    ...
    {
        App::$hooks[] = ['filter', $hook, $callback, $priority, $accepted];
        if ($hook === 'excerpt_length' && $callback instanceof \Closure) {
            \RRZE\Newsletter\Tests\Support\EditorEnvironment::$excerptFilters[$priority][spl_object_id($callback)] = $callback;
        }
        return true;
    }
