...
const PostInserterBlock = ({
    ...
    useEffect(() => {
        ...
        if (0 < postList.length) {
            ...
            const images = [];
            postList.map(
                post => post.featured_media && images.push(post.featured_media)
            );
        ...
        <Fragment>
            ...
            <BlockControls>
                {attributes.displayFeaturedImage && (
                    <ToolbarGroup controls={blockControlsImages} />
                )}
            </BlockControls>

            <div className="rrze-newsletter-post-inserter">
                <div className="rrze-newsletter-post-inserter__header">
                    {Icon}
                    <span>{__("Post Inserter", "rrze-newsletter")}</span>
                </div>
                <div className="rrze-newsletter-post-inserter__preview">
                    {isReady ? (
                        <BlockPreview
