...
class AutocompleteTokenField extends Component {
    ...
    getValuesForLabels(labels) {
            ...
            return labels.reduce((acc, label) => {
                Object.keys(validValues).forEach((key) => {
                    if (validValues[key] === label) {
                        ...
                        const value = isNaN(parseInt(key))
                            ? key.toString()
                            : parseInt(key);
        ...
        return labels.map((label) =>
            Object.keys(validValues)
                .map((key) =>
                    isNaN(parseInt(key)) ? key.toString() : parseInt(key)
                )
    ...
    render() {
        ...
        const classNames = [
            "rrze-newsletter-autocomplete-tokenfield__input-container",
        ];
        ...
        return (
            <div className="rrze-newsletter-autocomplete-tokenfield">
                ...
                {help && (
                    <p className="rrze-newsletter-autocomplete-tokenfield__help">
                        {help}
                    </p>
                )}
            </div>
