...
/**
 * Date/Calendar recursion
 * Based on When() - https://github.com/tplaner/When
 */
class Recurrence extends DateTime
{
    const EXCEPTION = 0;
    const IGNORE = 2;
    ...
    {
        if (self::dateTimeObject($startDate)) {
        ...
        throw new Exception(
            sprintf(
                '%s: Accepts valid DateTime objects',
                __METHOD__
            )
        );
    }
    ...
    public function freq($frequency)
    {
        ...
        throw new Exception(
            sprintf(
                '%1$s: Accepts %2$s',
                __METHOD__,
                rtrim(implode(', ', self::$frequencies), ',')
            )
        );
    }
    ...
    {
        if (self::dateTimeObject($endDate)) {
    ...
    public function bysecond($seconds, $delimiter = ',')
    {
        ...
        throw new Exception(
            sprintf(
                '%s: Accepts numeric values between 0 and 60',
                __METHOD__
            )
        );
    }
    ...
    public function byminute($minutes, $delimiter = ',')
    {
        ...
        throw new Exception(
            sprintf(
                '%s: Accepts numeric values between 0 and 59',
                __METHOD__
            )
        );
    }
    ...
    public function byhour($hours, $delimiter = ',')
    {
        ...
        throw new Exception(
            sprintf(
                '%s: Accepts numeric values between 0 and 23',
                __METHOD__
            )
        );
    }
    ...
    public function byday($bywdaylist, $delimiter = ',')
    {
        ...
        if (is_array($bywdaylist) && self::daysList($bywdaylist)) {
        ...
        throw new Exception(
            sprintf(
                '%s: Accepts (optional) positive and negative values between 1 and 53 followed by a valid week day',
                __METHOD__
            )
        );
    }
    ...
    public function exclusions($exclusionList, $delimiter = ',')
    {
        ...
        if (is_array($exclusionList) && self::dateTimeList($exclusionList)) {
            $this->exclusions = array_filter($exclusionList, [__CLASS__, 'dateTimeObject']);
            return $this;
        }

        throw new Exception(
            sprintf(
                '%s: Accepts (optional) a array of date time objects or a string seperated by a specified delimiter.',
                __METHOD__
            )
        );
    }
    ...
    public function bymonthday($bymodaylist, $delimiter = ',')
    {
        ...
        throw new Exception(
            sprintf(
                '%s: Accepts positive and negative values between 1 and 31.',
                __METHOD__
            )
        );
    }
    ...
    public function byyearday($byyrdaylist, $delimiter = ',')
    {
        ...
        throw new Exception(
            sprintf(
                '%s: Accepts positive and negative values between 1 and 366.',
                __METHOD__
            )
        );
    }
    ...
    public function byweekno($bywknolist, $delimiter = ',')
    {
        ...
        throw new Exception(
            sprintf(
                '%s: Accepts positive and negative values between 1 and 53.',
                __METHOD__
            )
        );
    }
    ...
    public function bymonth($bymolist, $delimiter = ',')
    {
        ...
        throw new Exception(
            sprintf(
                '%s: Accepts values between 1 and 12.',
                __METHOD__
            )
        );
    }
    ...
    public function occursOn(DateTime $date)
    {
        ...
        if (isset($this->bydays)) {
            if (
                !in_array(0 . $dayOfWeekAbr, $this->bydays) &&
        ...
        if (isset($this->byyeardays)) {
            if (
                !in_array($yearDay, $this->byyeardays) &&
    ...
    public function getOccurrencesBetween($startDate, $endDate, $limit = NULL)
    {
        ...
        if (
            $thisClone->rangeLimit == count($all_occurrences)
     ...
     */
    protected static function getFirstWeekStartDate($startDate, $wkst)
    {
    ...
    {
        $this->prepareDateElements(false);
    ...
    protected function prepareDateElements($limitRange = true)
    {
        ...
        if (!isset($this->freq) && self::byFreqValid($this->freq, $this->byweeknos, $this->byyeardays, $this->bymonthdays)) {
            throw new Exception(
                sprintf(
                    '%s: Frequency required.',
                    __METHOD__
                )
            );
        }
    ...
    protected static function prepareItemsList($items, $delimiter = ',', $validator = null)
    {
        ...
        if (is_array($_items) && self::itemsList($_items, $validator)) {
            return $_items;
        }
     ...
     * @return bool
     */
    protected static function daysList($days)
    {
        foreach ($days as $day) {
     ...
     * @return bool
     */
    protected static function itemsList($items, $validator)
    {
    ...
    protected static function byFreqValid($freq, $byweeknos, $byyeardays, $bymonthdays)
    {
    ...
    protected static function yearDayNum($day)
    {
        return self::ordYrDay(abs($day));
    }

    protected static function ordYrDay($ordyrday)
    {
        return ($ordyrday >= 1 && $ordyrday <= 366);
    }

    protected static function monthDayNum($day)
    {
    ...
    protected static function setPosDay($day)
    {
     ...
     * @return bool
     */
    protected static function ordMoDay($ordmoday)
    {
     ...
     * @return bool
     */
    protected static function weekNum($week)
    {
     ...
     * @return bool
     */
    protected static function ordWk($ordwk)
    {
     ...
     * @return bool
     */
    protected static function hour($hour)
    {
     ...
     * @return bool
     */
    protected static function minute($minute)
    {
     ...
     * @return bool
     */
    protected static function second($second)
    {
     ...
     * @return bool
     */
    protected static function weekDay($weekDay)
    {
     ...
     * @return bool
     */
    protected static function frequency($frequency)
    {
     ...
     * @return bool
     */
    protected static function dateTimeObject($dateTime)
    {
     ...
     * @return bool
     */
    protected static function dateTimeList(array $dateTimes)
    {
