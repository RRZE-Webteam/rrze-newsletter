		...
		<Fragment>
			<style>{ `${
				meta.rrze_newsletter_font_body
					? `#${ ELEMENT_ID } *:not( code ) { font-family: ${ meta.rrze_newsletter_font_body };}`
					: ' '
			}${
				meta.rrze_newsletter_font_header
					? `#${ ELEMENT_ID } h1, #${ ELEMENT_ID } h2, #${ ELEMENT_ID } h3, #${ ELEMENT_ID } h4, #${ ELEMENT_ID } h5, #${ ELEMENT_ID } h6 { font-family: ${ meta.rrze_newsletter_font_header };}`
					: ' '
			}` }</style>
			<div
				id={ ELEMENT_ID }
